...
func NewDefaultOpts(serviceName string) Opts {
	return Opts{
...
func New(ctx context.Context, opts Opts) func(context.Context) {
	...
	if opts.IsMetricsEnabled || opts.IsTracingEnabled {
...
func (o *Goteli) cleanup(ctx context.Context) {
	...
	if o.cleanupGrpcConnectionFunc != nil {
		...
		if err != nil {
			otelzap.Ctx(ctx).Warn("Cleanup grpc connection failed")
		}
	}
	...
	if o.syncLoggerFunc != nil {
		...
		if err != nil {
			otelzap.Ctx(ctx).Warn("Cleanup otel logger failed")
		}
	}
}
